...
void apply_css() {
    ...
    gtk_css_provider_load_from_data(provider,
        ...
        "}"
        ".header-title {"
        "  font-size: 15px; font-weight: bold; color: #ece9f7;"
        "}"
        ".ghost-pill {"
        "  font-size: 11px; padding: 7px 13px; border-radius: 999px;"
        "  background: rgba(255,255,255,0.05); color: #9b94b8;"
        "  border: 1px solid rgba(255,255,255,0.09);"
        "}"
        ".ghost-active {"
        "  color: #fb7185; background: rgba(251,113,133,0.14);"
        "  border-color: rgba(251,113,133,0.4);"
        "}"
        ".search-box {"
        "  background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.09);"
        "  border-radius: 14px; padding: 4px 14px; color: #ece9f7;"
        "}"
        ".search-box:focus { border-color: rgba(0, 0, 0, 0.44); }"
        ".tab-btn {"
        "  font-size: 11.5px; padding: 6px 12px; border-radius: 10px;"
        "  background: rgba(255,255,255,0.05); color: #9b94b8;"
        "  border: 1px solid transparent; min-height: 24px;"
        "}"
        ".tab-btn:checked {"
        "  background: rgba(192,132,252,0.16); color: #c084fc;"
        "  border-color: rgba(192,132,252,0.3);"
        "}"
        "flowbox {"
        "  background: transparent; padding: 0 16px 16px;"
        "}"
        "flowboxchild {"
        "  background: transparent; padding: 0; outline: none; border: none;"
        "}"
        ...
        "}"
        "flowboxchild:hover .card { border-color: #c084fc; }"
        ".card.wide { min-width: 420px; }"
        ".card-text { font-size: 12px; color: #ece9f7; }"
        ".card-code { font-family: monospace; font-size: 11px; color: #60d9c9; }"
        ".meta { font-size: 10px; color: #9b94b8; margin-top: 6px; }"
        ".pin-flag {"
        "  background: rgba(251,191,103,0.18); color: #fbbf67;"
        "  border-radius: 50%; font-size: 10px; padding: 2px 6px;"
        "  margin-bottom: 4px;"
        "}"
        ".img-wrap {"
        "  background: linear-gradient(135deg,#2c2740,#1b1828);"
        "  border-radius: 10px; margin-bottom: 8px;"
        "}"
        "menu { background: rgba(30, 30, 40, 0.95); border-radius: 8px; padding: 4px; border: 1px solid rgba(255,255,255,0.09); }"
        "menuitem { color: #ece9f7; padding: 6px 12px; border-radius: 4px; }"
        "menuitem:hover { background: rgba(192,132,252,0.3); }"
        , -1, NULL);
